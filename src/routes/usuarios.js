...
const usuariosController = require(path.resolve(
  __dirname,
    ...
    router.post(
      ...
      [
        ...
        check("contrasena")
          .isLength({ min: 6 })
          .withMessage(
            "La contraseña debe tener un mínimo de 6 caractéres al menos una letra y un número"
          ),
        ...
        body("avatar")
          ...
          .withMessage(
            "Solo debe seleccionar archivos  con extensión JPG, JPEG, PNG o GIF"
          ),
      ],
